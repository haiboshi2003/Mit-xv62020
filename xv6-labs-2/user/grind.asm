...
go(int which_child)
{
  ...
  int fd = -1;
      ...
      sbrk(6011);
      fc:	6a05                	lui	s4,0x1
      fe:	77ba0a13          	addi	s4,s4,1915 # 177b <buf.1256+0xd3>
    ...
    if(what == 1){
     ...
     39a:	31258593          	addi	a1,a1,786 # 16a8 <buf.1256>
     39e:	854e                	mv	a0,s3
     ...
     3b2:	2fa58593          	addi	a1,a1,762 # 16a8 <buf.1256>
     3b6:	854e                	mv	a0,s3
