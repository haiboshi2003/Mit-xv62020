...
00000000000011ce <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1266:	e1e78793          	addi	a5,a5,-482 # 8080 <big.1290>
...
000000000000206a <bigargtest>:
{
  ...
  close(fd);
    ...
    20d2:	eb278793          	addi	a5,a5,-334 # 7f80 <args.1827>
    20d6:	00006697          	auipc	a3,0x6
    20da:	fa268693          	addi	a3,a3,-94 # 8078 <args.1827+0xf8>
    ...
    20f2:	e9258593          	addi	a1,a1,-366 # 7f80 <args.1827>
